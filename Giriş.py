...
st.set_page_config(
    ...
    page_icon="pages//images//Leonardo_Phoenix_Create_a_modern_sleek_logo_for_the_stock_trad_2.jpg",  # İkon için görsel yolu
    layout="wide",
...
with col2:
    st.image(image, caption="Kripto Dünyasına Hoş Geldiniz", use_container_width=True)
)
