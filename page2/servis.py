...
st.set_page_config(
    ...
    page_icon="github.com//sonmez1249//Tradementorai-website//tree//main//page2Leonardo_Phoenix_Create_a_modern_sleek_logo_for_the_stock_trad_2.jpg",  # İkon dosya yolu
    layout="wide",
